...
public class ejercicio_05_44 {
    public static void main(String[] args) {
        try {
            ...
            int digInsertar = Integer.parseInt(System.console().readLine("Introduzca la el dígito que quiere insertar: "));
            if (digInsertar > 9) {
            ...
            while (aux2>0) {
                ...
                else if (actual==partirEn) parte2=(parte2*10+digInsertar)*10+ultDig;
